...
tmpfile = os.getcwd()+'/tmp/gfwlisttmp'
# do not write to router internal flash directly
outfile = os.getcwd()+'/tmp/gfwlist.conf'
...
for line in tfs.readlines():
    ...
    # fs.write('#' + line)
        ...
        if domain:
            ...
            print
            'no valid domain in this line: ' + line

tfs.close()
fs.close();

print
'moving generated file to dnsmasg directory'
shutil.move(outfile, rulesfile)

print
'restart dnsmasq...'
print
os.popen('/etc/init.d/dnsmasq restart').read()
